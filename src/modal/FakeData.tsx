...
export const fakeNotification: TypeNotification[] = [
  {
    ...
    user: {
      ...
      picture: 'https://img.freepik.com/free-vector/cute-pig-sitting-cartoon-vector-icon-illustration-animal-nature-icon-concept-isolated-premium-flat_138676-7818.jpg?t=st=1690733118~exp=1690733718~hmac=e9cb622d4f14635fad29588f7437a9648a04a787d3410f4e5922feef26248283',
...

  {
    ...
    content: 'Bạn có bài tập mới đi con mẹ mày nhác vãi lồn ra asdasdasdasd 1eqweqweq',
    user: {
      fullName: 'Nguyễn Văn A',
      email: 'concu@gmail.com',
      picture: 'https://img.freepik.com/free-vector/cute-pig-sitting-cartoon-vector-icon-illustration-animal-nature-icon-concept-isolated-premium-flat_138676-7818.jpg?t=st=1690733118~exp=1690733718~hmac=e9cb622d4f14635fad29588f7437a9648a04a787d3410f4e5922feef26248283',
